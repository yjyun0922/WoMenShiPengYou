...
#FILL THIS OUT# 
TEXT_LOCATION_LABEL = '/home/waynelin/Desktop/fashion/data/obj_detection/short_cat.txt' 
TEXT_LOCATION_BBOX = '/home/waynelin/Desktop/fashion/data/obj_detection/short_bbox.txt'
TEXT_LOCATION_CAT = '/home/waynelin/Desktop/fashion/data/obj_detection/list_category_cloth.txt'
TEXT_LOCATION_PART = '/home/waynelin/Desktop/fashion/data/obj_detection/short_partition.txt'
...
def label_list_partitioned(text_location_label, text_location_part): 
	...
	our_file = our_file.read().splitlines()
		...
		file_name = '/home/waynelin/Desktop/fashion/data/' + our_string[0]
...
def bbox_list_partitioned(text_location_bbox, text_location_part): 
	...
	our_file = our_file.read().splitlines()
		...
		address = our_string[0]
                ...
                image = cv.imread('/home/waynelin/Desktop/fashion/data/' + address)
